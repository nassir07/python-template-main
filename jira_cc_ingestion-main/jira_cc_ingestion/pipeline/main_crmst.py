...
from jira_cc_ingestion.config import CRMST_PROJECT  # noqa: E402
...
def main(token_auth, user_sql, password_sql):
    """main"""
    # treat CRMST project
    logger.info(f"treating {CRMST_PROJECT['name']} project...")
    ingest_project_data(token_auth, user_sql, password_sql, CRMST_PROJECT)
    logger.info(f"{CRMST_PROJECT['name']} project is treated successfully!")
