...
from jira_cc_ingestion.config import CTH_PROJECT  # noqa: E402
...
def main(token_auth, user_sql, password_sql):
    """main"""
    # treat CTH project
    logger.info(f"treating {CTH_PROJECT['name']} project...")
    ingest_project_data(token_auth, user_sql, password_sql, CTH_PROJECT)
    logger.info(f"{CTH_PROJECT['name']} project is treated successfully!")
