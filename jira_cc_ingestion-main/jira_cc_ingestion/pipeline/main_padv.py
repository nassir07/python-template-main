...
def main(token_auth, user_sql, password_sql):
    """main"""
    # treat PADV project
    logger.info(f"treating {PADV_PROJECT['name']} project...")
    ingest_project_data(token_auth, user_sql, password_sql, PADV_PROJECT)
    logger.info(f"{PADV_PROJECT['name']} project is treated successfully!")
