...
from jira_cc_ingestion.config import LIGHT25_PROJECT  # noqa: E402
...
def main(token_auth, user_sql, password_sql):
    """main"""
    # treat IPBM project
    logger.info(f"treating {LIGHT25_PROJECT['name']} project...")
    ingest_project_data(token_auth, user_sql, password_sql, LIGHT25_PROJECT)
    logger.info(f"{LIGHT25_PROJECT['name']} project is treated successfully!")
