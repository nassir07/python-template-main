...
from jira_cc_ingestion.config import SWP_PROJECT  # noqa: E402
...
def main(token_auth, user_sql, password_sql):
    """main"""
    # treat SWP project
    logger.info(f"treating {SWP_PROJECT['name']} project...")
    ingest_project_data(token_auth, user_sql, password_sql, SWP_PROJECT)
    logger.info(f"{SWP_PROJECT['name']} project is treated successfully!")
