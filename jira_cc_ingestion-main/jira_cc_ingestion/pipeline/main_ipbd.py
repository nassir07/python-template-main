...
from jira_cc_ingestion.config import IPBD_PROJECT  # noqa: E402
...
def main(token_auth, user_sql, password_sql):
    """main"""
    # treat IPBM project
    logger.info(f"treating {IPBD_PROJECT['name']} project...")
    ingest_project_data(token_auth, user_sql, password_sql, IPBD_PROJECT)
