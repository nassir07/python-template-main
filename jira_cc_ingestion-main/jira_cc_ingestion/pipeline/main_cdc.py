...
def main(token_auth, user_sql, password_sql):
    """main"""
    # treat CDC project
    logger.info(f"treating {CDC_PROJECT['name']} project...")
    ingest_project_data(token_auth, user_sql, password_sql, CDC_PROJECT)
    logger.info(f"{CDC_PROJECT['name']} project is treated successfully!")
