...
def main(token_auth, user_sql, password_sql):
    """main"""
    # treat ADBK25 project
    logger.info(f"treating {ADBK25_PROJECT['name']} project...")
    ingest_project_data(token_auth, user_sql, password_sql, ADBK25_PROJECT)
    logger.info(f"{ADBK25_PROJECT['name']} project is treated successfully!")
