...
def main(token_auth, user_sql, password_sql):
    """main"""
    # treat IPNATH project
    logger.info(f"treating {IPNATH_PROJECT['name']} project...")
    ingest_project_data(token_auth, user_sql, password_sql, IPNATH_PROJECT)
    logger.info(f"{IPNATH_PROJECT['name']} project is treated successfully!")
