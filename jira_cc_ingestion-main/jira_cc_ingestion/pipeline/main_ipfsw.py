...
from jira_cc_ingestion.config import IPFSW_PROJECT  # noqa: E402
...
def main(token_auth, user_sql, password_sql):
    """main"""
    # treat IPFSW project
    logger.info(f"treating {IPFSW_PROJECT['name']} project...")
    ingest_project_data(token_auth, user_sql, password_sql, IPFSW_PROJECT)
    logger.info(f"{IPFSW_PROJECT['name']} project is treated successfully!")
