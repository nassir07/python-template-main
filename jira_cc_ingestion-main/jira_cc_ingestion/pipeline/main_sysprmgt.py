...
from jira_cc_ingestion.config import SYSPRMGT_PROJECT  # noqa: E402
...
def main(token_auth, user_sql, password_sql):
    """main"""
    # treat SWP project
    logger.info(f"treating {SYSPRMGT_PROJECT['name']} project...")
    ingest_project_data(token_auth, user_sql, password_sql, SYSPRMGT_PROJECT)
    logger.info(f"{SYSPRMGT_PROJECT['name']} project is treated successfully!")
